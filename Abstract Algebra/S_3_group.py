...
I = np.identity(3).astype(int) # This is the neutral element of the group representing a function that maps A to A with no 
...
o = lambda x,y : np.matmul(x,y).astype(int) # This combined the generators

...
# This is an interactive demo shows how a cubic spline relates to the lines that define it
# Click the red dots to move them around and see the spline change shape
# Note: This code uses window position properties to know if a red dot has been clicked which may not work on every monitor :(
